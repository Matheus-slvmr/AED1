/* Nerdilton adora Matemática, mas ele não tem a memória muito boa para memorizar fórmulas. Geralmente ele entende como a fórmula funciona e deriva o valor de saída da fórmula. Ele precisa responder a um
